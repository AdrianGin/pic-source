...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1387409687/uint16toa.o ${OBJECTDIR}/_ext/1387409687/uint8toa.o ${OBJECTDIR}/_ext/1539374888/adc.o ${OBJECTDIR}/_ext/1539409824/dmadef.o ${OBJECTDIR}/_ext/1102637588/dmaSPI.o ${OBJECTDIR}/_ext/178018670/dmaUart.o ${OBJECTDIR}/_ext/481915157/hardUart.o ${OBJECTDIR}/_ext/1539392564/spi.o ${OBJECTDIR}/_ext/1237177208/pff.o ${OBJECTDIR}/_ext/1777254300/sd.o ${OBJECTDIR}/_ext/1777254300/picsd.o ${OBJECTDIR}/_ext/1532717492/ringbuffer.o ${OBJECTDIR}/_ext/43898991/delay.o ${OBJECTDIR}/_ext/2105551405/linkedlist.o ${OBJECTDIR}/_ext/1218362732/stack.o ${OBJECTDIR}/_ext/1045608385/waveplayer.o ${OBJECTDIR}/_ext/1045608385/picdriverwav.o ${OBJECTDIR}/hardwareSpecific.o ${OBJECTDIR}/main.o
...
${OBJECTDIR}/_ext/1387409687/uint16toa.o: ../../../FuncLib/Other/mmculib/uint16toa.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1387409687/uint16toa.o.d" $(SILENT) -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION) -Wall -D__PIC24H__ -DFcy=40000000 -I"../../../FuncLib/Other" -I"/D:/Microchip/MPLAB C30/include" -I"../../Peripherals" -I"../.." -I"../../Peripherals/hardUART24H" -I"/D:/Microchip/MPLAB C30/support/PIC24H/h" -I"../../../FuncLib/Other/RingBuffer" -I"/D:/Microchip/MPLAB C30/support/peripheral_30F_24H_33F" -I"../../../FuncLib/Other/linkedlist" -I"M:/Robotics/Source/PICResource/24HJ/WaveplayerPFS" -I"../../../FuncLib/External" -I"../../../FuncLib/Applications" -I"./" -Os -fomit-frame-pointer -MMD -MF "${OBJECTDIR}/_ext/1387409687/uint16toa.o.d" -o ${OBJECTDIR}/_ext/1387409687/uint16toa.o ../../../FuncLib/Other/mmculib/uint16toa.c  
