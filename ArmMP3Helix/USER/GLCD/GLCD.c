...
void LCD_Initializtion(void)
{
	...
	else if( DeviceCode == 0x8989 )
	{
	    ...
	    LCD_WriteReg(0x0001,0x293F);    delay_ms(50);   /* 驱动输出控制320*240 0x2B3F */
	    LCD_WriteReg(0x0002,0x0600);    delay_ms(50);
	    LCD_WriteReg(0x0010,0x0000);    delay_ms(50);
	    LCD_WriteReg(0x0011,0x6078);    delay_ms(50);   /* 定义数据格式 16位色 横屏 0x6070, 0x6078 sometimes we might want to rotate */
