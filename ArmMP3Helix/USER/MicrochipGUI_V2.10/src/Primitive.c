...
void SetFont(void *font)
{
    ...
    switch(*((SHORT *)font))
    {
        ...
        case FLASHv:	//Note 4: ÒÆÖ²µ½STM32
    ...
    switch(*((SHORT *)_font))
    {
        ...
        case EXTERNAL:
			...
			if( HZLibFlag )
			{
			   ...
			   High8bit=ch>>8;
			   Low8bit=(ch&0x00ff);
			   //df_read_open(HZLIB_ADDR+32*((High8bit-0xa0-1)*94+(Low8bit-0xa0-1)));
			   //df_read(chImage,32); 
			}
			else
	        {
...
SHORT GetTextWidth(XCHAR *textString, void *font)
{
    ...
    switch(*((SHORT *)font))
    {
        ...
        case FLASHv:	 //Note 6: ÒÆÖ²µ½STM32
            pHeader = (FONT_HEADER *) ((FONT_FLASH *)font)->address;
            fontFirstChar = pHeader->firstChar;
            fontLastChar = pHeader->lastChar;
            pChTable = (GLYPH_ENTRY *) (pHeader + 1);
    ...
    switch(*((SHORT *)font))
    {
        ...
        case RAM:
            return ((FONT_HEADER *) ((FONT_RAM *)font)->address)->height;
                ...
                #ifdef USE_FONT_FLASH
        case FLASHv:	//Note 5: ÒÆÖ²µ½STM32
...
SHORT GetImageWidth(void *bitmap)
{
    ...
    switch(*((SHORT *)bitmap))
    {
        ...
        case FLASHv:	//Note 7: ÒÆÖ²µ½STM32
...
SHORT GetImageHeight(void *bitmap)
{
    ...
    switch(*((SHORT *)bitmap))
    {
        ...
        case FLASHv:	  //Note 8: ÒÆÖ²µ½STM32
...
void PutImage16BPP(SHORT left, SHORT top, FLASH_BYTE *bitmap, BYTE stretch)
{
    volatile FLASH_WORD *flashAddress;
    volatile FLASH_WORD *tempFlashAddress;
    WORD                sizeX, sizeY;
    volatile WORD       x, y;
    WORD                xc, yc;
    WORD                temp;
    volatile BYTE       stretchX, stretchY;
