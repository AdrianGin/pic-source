...
#ifndef DROIDSANSAA_H_FILE
#define DROIDSANSAA_H_FILE
/*****************************************************************************
 * SECTION:  Includes
 *****************************************************************************/
 ...
 * Label: DroidSans_Bold_12
 * Description:  Height: 15 pixels, 1 bit per pixel, Range: ' ' to '~'
 ***********************************/
extern const FONT_FLASH DroidSans_Bold_12;
#define DroidSans_Bold_12_SIZE    (2038)
#endif
